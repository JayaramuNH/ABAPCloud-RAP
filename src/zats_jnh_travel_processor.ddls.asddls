...
define root view entity ZATS_jnh_TRAVEL_PROCESSOR
  provider contract transactional_query as projection on ZATS_JNH_TRAVEL
{
    ...
    /* Associations */
    _Agency,
    _Booking: redirected to composition child ZATS_JNH_BOOKING_PROCESSOR,
    _Currency,
    _Customer,
    _OverallStatus,
